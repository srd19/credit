/*
 * Copyright (c) 2004-2009, Jean-Marc Fran̤ois. All Rights Reserved.
...
public class NewClass2
{
	...
	throws java.io.IOException
	{
		...
		ObservationDiscrete<Packet> packetOk = Packet.FRAUD.observation();
		ObservationDiscrete<Packet> packetLoss = Packet.GENUINE.observation();
