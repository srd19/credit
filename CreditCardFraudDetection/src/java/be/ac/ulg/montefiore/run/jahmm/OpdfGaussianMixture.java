...
package src.be.ac.ulg.montefiore.run.jahmm;

import java.text.NumberFormat;
import java.util.Arrays;
import java.util.Collection;

import src.be.ac.ulg.montefiore.run.distributions.GaussianDistribution;
import src.be.ac.ulg.montefiore.run.distributions.GaussianMixtureDistribution;
