...
package be.ac.ulg.montefiore.run.jahmm;
 ...
 import dal.GMailSender;
 import java.math.BigInteger;
import src.be.ac.ulg.montefiore.run.jahmm.test.NewClass1;
import src.be.ac.ulg.montefiore.run.jahmm.test.NewClass1.*;
import java.io.*;
import java.util.*;
/**
...
//put the means in ascending order
  ...
  float diff2t1=0;
  float diff3t1=0;
  String c3="mailtesthmm";
  String c4="mailtesthmm1@gmail.com";
...
//put the means in ascending order
   ...
   float difft111=0;
  float difft211=0;float difft131=0;
  float diff1t11=0;float diff2t11=0;
  float diff3t11=0;
    public void mc(String s1,String s2)
    {try
        {GMailSender sender1 = new GMailSender(c4,c3);
        sender1.sendMail("disconnection of set","This is your set for"+s1+s2,c4,c4);}
